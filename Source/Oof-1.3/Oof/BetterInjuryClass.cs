...
namespace Oof
{
    ...
    public class InjuryClassChanger
    {
        static InjuryClassChanger()
        {
            ...
            BodyPartDefOf.Liver.tags.RemoveAt(1);
        }
    }
    ...
    public class BetterInjury : Hediff_Injury
    {
        ...
        public override string TipStringExtra
        {
            get
            {
                ...
                if (Plugged)
                {
                    result += "\n Exit wounds are closed therefore bleeding is decreased";
                }
                if (hemod)
                {
                    result += "\n Hemostaised by either a bandage or a hemostatic agent. Bleeding heavily decreased";
                }
                return result;
            }
        }
    ...
    public class LungCollapse : BetterInjury
    {
        ...
        public override string TipStringExtra
        {
            get
            {
                if (IsFresh)
                {
                    return "Fresh - has chance to block airways";
                }

                return "Tended, still needs to be removed with operation but won't block breathing";
            }
        }
    }
